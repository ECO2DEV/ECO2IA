export const DataDashboard = {
  DashboardTitle: 'Bienvenido a ECO2',
  MattechChatTitle: 'ECO2CHAT',
  MattechChatDescription:
    'El usuario hace una pregunta y la IA responde. Mantenemos el historial de las últimas 10 solicitudes del usuario.',
  ...
  MattDescription:
    'La IA proporciona una descripción detallada de un producto específico ingresado por el usuario.',
  MattResumeTitle: 'ECO2RESUME',
  MattResume: 'La IA toma un texto largo y lo resume en unas pocas líneas.',
  MatCVTitle: 'ECO2CV',
  MatCVDescription:
    'La IA genera un CV a partir de los datos proporcionados por el usuario.'
};
