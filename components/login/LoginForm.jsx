            ...
            <div className="mt-6">
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div className="relative z-0 w-full mb-5 group">
                  ...
                  <label
                    htmlFor="password"
                    className="peer-focus:font-medium absolute text-xl leading-6 text-white dark:text-[#21c284] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-emerald-600 peer-focus:dark:text-emerald-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >
