            ...
            >
              ...
              <button
                ...
                className={classNames(
                  ...
                  'w-full cursor-pointer mt-6 block rounded-md py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2'
                )}
              >
                {tier.cta}
              </button>
