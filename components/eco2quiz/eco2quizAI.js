        ...
        <div className="w-full max-w-md mx-4">
          {loading ? (
            ...
            <div className="flex flex-col gap-2">
              {Array.from(
                { length: formState.questionQuantity },
                (_, index) => (
                        ...
                        <details open className="mb-1 p-4  ">
                          ...
                          <div className="flex flex-col justify-center">
                            {posibleAnswers.map((posibleAnswer, index) => (
                              ...
                              >
                                {posibleAnswer === "NA" ? (
                                  <p className="flex justify-center ml-2 text-eco2MainColor text-center items-center">
                                    {correctAnswer}
                                  </p>
                                ) : (
                                ...
                                isAnswerVisible ? (
                                  <p className="flex font-mediumjustify-center ml-2 text-eco2MainColor text-center items-center">
