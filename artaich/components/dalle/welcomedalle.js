...
export const WelcomeDalle = () => {
  ...
  return (
    <div className="md:flex items-start text-center gap-3.5 md:mt-16 xl:mt-24 mt-18">
      <div className="flex flex-col mb-2 md:mb-auto gap-3.5 flex-1 mt-10">
      ...
      <div className="flex flex-col mb-2 md:mb-auto gap-3.5 flex-1">
        <h2 className="flex gap-3 items-center m-auto text-lg font-normal md:flex-col md:gap-2">
          <ZapIcon /> {DataMattImage.Capabilities}
        </h2>
        <ul className="flex flex-col gap-1 w-full sm:max-w-md m-auto ">
      ...
      <div className="flex flex-col mb-24 md:mb-auto gap-3.5 flex-1">
        <h2 className="flex gap-3 items-center m-auto text-lg font-normal md:flex-col md:gap-2">
          <WarningIcon /> {DataMattImage.Limitation}
        </h2>
        <ul className="flex flex-col gap-1 w-full sm:max-w-md m-auto ">
