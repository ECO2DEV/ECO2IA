          ...
          <div className="flex gap-2 sm:flex-row items-center">
            ...
            <div className="flex md:ml-2">
              <button
                type="submit"
                disabled={submitting}
                className="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                {submitting
