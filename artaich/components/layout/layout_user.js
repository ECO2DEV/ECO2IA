...
export default function LayoutUser({ children }) {
  ...
  const shouldShowTopNavBar = ['/chatgpt', '/dalle', '/mattraduct', '/sportcoach', '/matquiz', '/matdescription', '/mattresum', '/matcv'].includes(currentPath);
  // console.log('Image_url' + children.props.user.avatar);
  const navigationForMobile = shouldShowTopNavBar && currentPath !== '/dashboard' ? navigation.find(item => item.href === currentPath)?.name || '' : '';
  return (
    <>
      {/*
      ...
      */}
      ...
      <div className="">
        ...
        <div className="flex flex-1 flex-col lg:pl-64">
          <div className="sticky top-0 z-10 bg-white pl-1 pt-1 sm:pl-3 sm:pt-3 flex items-center justify-between border-b border-gray-300">
             {shouldShowTopNavBar && currentPath !== '/dashboard' && (
              <div className='ml-8'>
                <h2 className="text-gray-500 text-2xl font-">
