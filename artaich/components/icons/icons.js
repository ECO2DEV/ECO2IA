...
export function ShortAnswerIcon() {
  return (
    <svg
      ...
      className="w-6 h-6 text-gray-900  rounded-full  bg-gray-200 text-gray-700 hover:bg-sky-700 hover:text-sky-200 hover:-scale-110 transition-colors duration-150"
      fill="none"
      stroke="currentColor"
      strokeWidth={1.5}
      viewBox="0 0 24 24"
