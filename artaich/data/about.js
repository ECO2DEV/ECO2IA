...
aboutiaavaiblesvalue: '+10',
aboutnotreplateforme: "Notre plateforme d'IA",
aboutplateformetext: "Notre plateforme d'IA est conçue pour répondre aux besoins des particuliers, des étudiants et des entreprises. Elle permet aux entreprises de gérer facilement leurs propres modèles d'IA par domaine d'activité, tout en offrant la possibilité de créer des IA personnalisées répondant aux besoins spécifiques de chaque entreprise. Elle est également conçue pour aider les particuliers et les étudiants à se familiariser avec les IA et à comprendre leur potentiel.",
aboutworldclass: "Leader en IA : ",
aboutworldclassdescription: "Notre objectif est d'être en perpétuelle évolution pour devenir la référence en matière d'intelligence artificielle.",
aboutresponsibility: 'Responsabilité : ',
aboutresponsibilitydescription: "Nous nous engageons à créer des solutions d'IA éthiques et durables pour un impact positif sur la société.",
aboutsupportive: "Communauté soudée : ",
aboutsupportivedescription: "Rejoignez une communauté d'experts et d'utilisateurs passionnés, partageant leurs connaissances et leurs expériences.",
aboutlearnign: "Apprentissage : ",
aboutlearnigndescription: "Bénéficiez de cours et d’exemples de qualité supérieure pour développer vos compétences en intelligence artificielle.",
aboutshareeverything: "Magie de la technologie : ",
aboutshareeverythingdescription: "Découvrez le pouvoir fascinant de l'IA et comment elle peut transformer votre vie quotidienne.",
aboutenjoy: "Évolution constante : ",
aboutenjoydescription: "Notre plateforme d'IA s'améliore et se développe chaque jour pour rester à la pointe de l'innovation.",
aboutourteam: 'Notre équipe',
aboutourteamdescription: "Voici les dirigeants ainsi que les gérants de chacun de nos pôles",
