...
export default function SignIn() {
    ...
    return (
        ...
        <div className="flex flex-1 flex-col justify-center py-8 px-8 pb-20 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-gray-900">
              ...
              <div className="mt-6">
                <form className="space-y-6"  onSubmit={onSubmit}>
                  ...
                  <div className="text-sm text-center">
                     ...
                     <a className="font-medium text-sm text-indigo-600 hover:text-indigo-500" onClick={() => handleModalRegister()}>
                        Créer une compte
                      </a>
        ...
        <Image className="absolute inset-0 h-full w-full object-cover" src={login_image} alt="login image" priority/>
