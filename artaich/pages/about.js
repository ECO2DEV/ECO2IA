            ...
            <main className="relative isolate">
                ...
                <div className="px-6 pt-14 lg:px-8">
                    <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
                        <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Nous sommes Mattech !</h2>
                ...
                <div className="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        <div className="grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 lg:max-w-none lg:grid-cols-2">
                            <div>
                                <h3 className='text-3xl font-bold tracking-tight text-white sm:text-3xl'> Introduction </h3>
                                <br />
                                <p>
                                    Nous sommes une start-up française créée par deux étudiants passionnés par l&#39;innovation
                                    technologique. Nous avons pour mission de révolutionner le monde de l&#39;IA en développant et en
                                    mettant en place différentes solutions d&#39;intelligence artificielle pour répondre aux besoins multiples
                                    de nos clients, qu&#39;il s&#39;agisse de particuliers, d&#39;étudiants ou d&#39;entreprises.
                                </p>
